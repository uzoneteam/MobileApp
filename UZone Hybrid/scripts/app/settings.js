...
var appSettings = {
    ...
    everlive: {
        apiKey: 'nlPFVLraO7sUP6YG', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: '7e82343ac1d146bf92d850684da43b2a',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '675b0ee0-2dcb-11e5-a9e3-8de6e825dc5b',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
